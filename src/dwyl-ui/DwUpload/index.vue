<template>
  <!-- <UploadOneImg v-if="isUploadOneImg" :fileUrl="modelValue" @change="changeUploadOneImg" /> -->
...
import { uploadApi } from '@/api/post'
...
import UploadOneImg from './UploadOneImg'
